...
- `#tbl-wcm`: 행 `<tr data-fc="2000|3000|4000|5000|6000">`, 셀 `<td data-series="nonAE">`·`<td data-series="ae">`(0.82/0.74, 0.68/0.59, 0.57/0.48, 0.48/0.40, 0.41/0.32). MPa 병기. 슬라이드 13·22의 표는 6,000 psi 공기연행 값을 0.33으로 적고 있으나 ACI 211.1 표(와 랩 엔진 `WC_TABLE.ae`)는 0.32다 — 글은 0.32를 쓰고, 슬라이드 오타는 사용자에게 알린다.
