...
<svg class="fig-svg" viewBox="0 0 720 264" role="img" aria-labelledby="fig1-title">
  ...
  <g font-family="var(--font-mono)" font-weight="500" font-size="12" fill="var(--muted)">
    ...
    <path d="M84,62 l8,76 M108,62 l8,76 M132,62 l8,76 M156,62 l8,76 M228,62 l8,76 M252,62 l8,76 M324,62 l8,76 M348,62 l8,76 M372,62 l8,76 M444,62 l8,76 M468,62 l8,76 M564,62 l8,76 M588,62 l8,76 M612,62 l8,76 M636,62 l8,76" stroke="var(--dark)" stroke-width="2" fill="none"/>
    <g font-family="var(--font-head)" font-weight="800" font-size="34" fill="var(--dark)" text-anchor="middle">
      <text x="190" y="112">H</text><text x="300" y="112">5</text><text x="410" y="112">S</text><text x="520" y="112">60</text>
    </g>
    <path d="M190,52 v22 M300,52 v22 M410,52 v22 M520,52 v22" stroke="var(--muted)" stroke-width="1.5" fill="none"/>
    <g text-anchor="middle" fill="var(--dark)">
      <text x="190" y="30">mill mark</text><text x="300" y="30">bar size</text><text x="410" y="30">steel type</text><text x="520" y="30">grade</text>
    </g>
    <g text-anchor="middle">
      <text x="190" y="46">producer's symbol</text><text x="300" y="46">#5</text><text x="410" y="46">S = A615 · W = A706</text><text x="520" y="46">60 ksi minimum yield</text>
    </g>
...
<svg class="fig-svg" viewBox="0 0 720 360" role="img" aria-labelledby="fig2-title">
  ...
  <g font-family="var(--font-mono)" font-weight="500" font-size="12" fill="var(--muted)">
    ...
    <text x="685" y="93" text-anchor="end">minimum tensile strength, 90 ksi</text>
    ...
    <text x="515" y="120" text-anchor="middle" fill="var(--dark)">necking</text>
...
<svg class="fig-svg" viewBox="0 0 720 308" role="img" aria-labelledby="fig4-title">
  ...
  <g font-family="var(--font-mono)" font-weight="500" font-size="12" fill="var(--muted)">
    ...
    <text x="470" y="80" fill="var(--dark)">#5 Grade 60: d = 0.625 in., D = 2.19 in.</text>
    <text x="470" y="100">#8 Grade 60: d = 1.000 in., D = 5 in.</text>
    <text x="470" y="120">#11 Grade 60: d = 1.410 in., D = 9.87 in.</text>
    <text x="470" y="150">outer surface strain ≈ d ÷ (D + d)</text>
    <text x="470" y="170">= 1 ÷ 4.5 ≈ 22 % for a 3½ d pin</text>
  </g>
</svg>
