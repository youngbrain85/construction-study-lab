...
<figure>
<svg class="fig-svg" viewBox="0 0 720 300" role="img" aria-labelledby="fig1-title">
  ...
  <g font-family="var(--font-mono)" font-weight="500" font-size="12" fill="var(--muted)">
    ...
    <text x="190" y="216" text-anchor="middle">small, closely spaced, everywhere in the paste</text>
    ...
    <text x="530" y="216" text-anchor="middle">large, irregular, few — a weak spot, not protection</text>
    <line x1="60" y1="248" x2="140" y2="248" stroke="var(--royal)" stroke-width="2"/>
    <path d="M140,248 l-7,-4 v8 z" fill="var(--royal)"/>
    <circle cx="168" cy="248" r="14" fill="var(--bg)" stroke="var(--dark)" stroke-width="1.5"/>
    <text x="196" y="252" fill="var(--dark)">freezing water is pushed into the nearest bubble, and the pressure lets go</text>
    <text x="60" y="278">Both kinds are counted by the meter. Only the small, close ones do the protecting.</text>
  </g>
</svg>
...
<svg class="fig-svg" viewBox="0 0 720 330" role="img" aria-labelledby="fig2-title">
  ...
  <g font-family="var(--font-mono)" font-weight="500" font-size="12" fill="var(--muted)">
    ...
    <text x="190" y="224" text-anchor="middle">air voids</text>
    ...
    <text x="458" y="164" text-anchor="middle">initial pressure line</text>
    ...
    <text x="322" y="196" text-anchor="end" fill="var(--royal)">main air valve</text>
    <path d="M300,168 h-8" stroke="var(--royal)" stroke-width="2"/>
    ...
    <text x="60" y="78">The more air the concrete holds, the further the needle falls — and that is the reading.</text>
  </g>
</svg>
...
<svg class="fig-svg" viewBox="0 0 720 300" role="img" aria-labelledby="fig3-title">
  ...
  <g font-family="var(--font-mono)" font-weight="500" font-size="12" fill="var(--muted)">
    <text x="60" y="34" fill="var(--dark)">One cubic yard of materials, air-free: 26.60 cu ft. The air rides on top.</text>
    <rect x="90" y="70" width="55.4" height="34" fill="var(--royal)" stroke="var(--bg)" stroke-width="1"/>
    <rect x="145.4" y="70" width="95.8" height="34" fill="var(--primary-50)" stroke="var(--bg)" stroke-width="1"/>
    <rect x="241.2" y="70" width="223.9" height="34" fill="var(--dark)" stroke="var(--bg)" stroke-width="1"/>
    <rect x="465.1" y="70" width="156.9" height="34" fill="var(--icy)" stroke="var(--bg)" stroke-width="1"/>
    <rect x="622" y="70" width="8.1" height="34" fill="var(--amber)" stroke="var(--dark)" stroke-width="1"/>
    <text x="60" y="92" text-anchor="end" fill="var(--dark)">Load A</text>
    <text x="646" y="92" fill="var(--dark)">27.00 cu ft → 148.4 lb/cu ft</text>
    <g font-size="10" fill="var(--bg)" text-anchor="middle">
      <text x="117" y="92">cem</text><text x="353" y="92">coarse aggregate</text>
    </g>
    <g font-size="10" fill="var(--dark)" text-anchor="middle">
      <text x="193" y="92">water</text><text x="543" y="92">fine aggregate</text>
    </g>
    <rect x="90" y="140" width="531.9" height="34" fill="var(--surface2)" stroke="var(--dark)" stroke-width="1"/>
    <rect x="622" y="140" width="20.8" height="34" fill="var(--amber)" stroke="var(--dark)" stroke-width="1"/>
    <text x="60" y="162" text-anchor="end" fill="var(--dark)">Load B</text>
    <text x="656" y="162" fill="var(--dark)">27.63 cu ft → 145.0 lb/cu ft</text>
    <text x="356" y="162" text-anchor="middle" fill="var(--dark)">the same 26.60 cu ft of materials</text>
    <path d="M626,196 v-16 M634,196 v-22" stroke="var(--amber)" stroke-width="1.5"/>
    <text x="620" y="212" fill="var(--amber)">air: 0.41 cu ft (1.5 %) → 1.04 cu ft (3.8 %)</text>
    <line x1="90" y1="248" x2="630" y2="248" stroke="var(--border)" stroke-width="1"/>
    <text x="60" y="272" fill="var(--dark)">Same mass, more volume: the density falls, the yield rises, and the cement is spread thinner.</text>
  </g>
</svg>
