...
test('MATERIALS: 믹스 디자인 2편·슬럼프·다짐 글이 등록돼 있고 page href 가 실제 파일을 가리킨다', () => {
  const pages = S.MATERIALS.filter(m => m.type === 'page');
  assert.deepEqual(pages.map(m => m.id), ['mix-design-1', 'mix-design-2', 'slump-test', 'soil-compaction']);
