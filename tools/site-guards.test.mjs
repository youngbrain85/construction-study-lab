...
test('article.css 와 글 페이지는 theme.css 토큰만 쓴다(리터럴 색 없음)', () => {
  const files = ['study/article.css', 'study/mix-design/index.html', 'study/mix-design/example/index.html', 'study/slump-test/index.html',
    ...
    'study/aggregate-gradation/index.html', 'study/aggregate-gradation/calc.js'];
...
test('Study 글 사진 폴더(slump 7 · soil 6 · cylinders 7 · gradation 4)의 모든 파일이 .jpg 이고 각 220 KB 이하다', () => {
  const dirs = { 'study/slump-test/img': 7, 'study/soil-compaction/img': 6, 'study/concrete-cylinders/img': 7, 'study/aggregate-gradation/img': 4 };
...
const ARTICLE_PAGES = ['study/mix-design/index.html', 'study/mix-design/example/index.html', 'study/slump-test/index.html', 'study/soil-compaction/index.html', 'study/concrete-cylinders/index.html', 'study/aggregate-gradation/index.html'];
