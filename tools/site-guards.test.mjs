...
test('Study 글 사진 폴더(slump 7 · soil 6 · cylinders 7)의 모든 파일이 .jpg 이고 각 220 KB 이하다', () => {
  const dirs = { 'study/slump-test/img': 7, 'study/soil-compaction/img': 6, 'study/concrete-cylinders/img': 7 };
