...
test('article.css 와 글 페이지는 theme.css 토큰만 쓴다(리터럴 색 없음)', () => {
  const files = ['study/article.css', 'study/mix-design/index.html', 'study/mix-design/example/index.html', 'study/slump-test/index.html',
    ...
    'study/aggregate-gradation/index.html', 'study/aggregate-gradation/calc.js', 'study/rebar-tension/index.html'];
...
const ARTICLE_PAGES = ['study/mix-design/index.html', 'study/mix-design/example/index.html', 'study/slump-test/index.html', 'study/soil-compaction/index.html', 'study/concrete-cylinders/index.html', 'study/aggregate-gradation/index.html', 'study/rebar-tension/index.html'];
